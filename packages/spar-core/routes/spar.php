...
Route::middleware($adminMiddleware)->prefix('admin/spar')->group(function () {
    ...
    Route::get('/orders', SparOrders::class)->name('admin.spar.orders');
    Route::get('/renewals', SparRenewals::class)->name('admin.spar.renewals');
    Route::get('/broadcast', SparBroadcast::class)->name('admin.spar.broadcast');
    Route::get('/win-back', SparWinBack::class)->name('admin.spar.winback');
