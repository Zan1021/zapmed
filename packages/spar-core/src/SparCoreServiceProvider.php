...
class SparCoreServiceProvider extends ServiceProvider
{
    ...
    private function registerLivewireComponents(): void
    {
        ...
        $components = [
            ...
            'spar.admin.orders'       => \Zapmed\SparCore\Livewire\Admin\SparOrders::class,
            'spar.admin.renewals'     => \Zapmed\SparCore\Livewire\Admin\SparRenewals::class,
            'spar.admin.broadcast'    => \Zapmed\SparCore\Livewire\Admin\SparBroadcast::class,
            'spar.admin.winback'      => \Zapmed\SparCore\Livewire\Admin\SparWinBack::class,
