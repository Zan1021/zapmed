<div>
    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-6 mb-8">
        <h3 class="text-lg font-semibold text-gray-900 mb-4">Import CSV File</h3>
        <p class="text-sm text-gray-500 mb-4">Upload a SPAR sales/prescription CSV file. Supported delimiters: pipe (|) or comma. The system will auto-detect pharmacies, patients, and prescription journeys.</p>

        <form wire:submit="import" class="flex items-end gap-4">
            <div class="flex-1">
            ...
            <button type="submit" wire:loading.attr="disabled" class="px-6 py-2.5 bg-green-600 text-white text-sm font-medium rounded-lg hover:bg-green-700 disabled:opacity-50 transition">
