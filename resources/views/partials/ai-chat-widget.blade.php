...
<div x-data="aiChatWidget()" class="fixed bottom-6 right-6 z-50">
    ...
    <div x-show="open" x-transition:enter="transition ease-out duration-300"
        ...
        <div class="h-[320px] overflow-y-auto p-4 space-y-3" id="chat-messages">
            ...
            <div class="flex items-start space-x-2">
                <div class="w-7 h-7 bg-zapmed-100 rounded-full flex items-center justify-center flex-shrink-0">
                    <svg class="w-4 h-4 text-zapmed-700" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9.663 17h4.673M12 3v1m6.364 1.636l-.707.707M21 12h-1M4 12H3m3.343-5.657l-.707-.707m2.828 9.9a5 5 0 117.072 0l-.548.547A3.374 3.374 0 0014 18.469V19a2 2 0 11-4 0v-.531c0-.895-.356-1.754-.988-2.386l-.548-.547z"/>
                    </svg>
                </div>
            ...
            <div x-show="loading" class="flex items-start space-x-2">
                <div class="w-7 h-7 bg-zapmed-100 rounded-full flex items-center justify-center flex-shrink-0">
                    <svg class="w-4 h-4 text-zapmed-700 animate-pulse" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9.663 17h4.673M12 3v1m6.364 1.636l-.707.707M21 12h-1M4 12H3m3.343-5.657l-.707-.707m2.828 9.9a5 5 0 117.072 0l-.548.547A3.374 3.374 0 0014 18.469V19a2 2 0 11-4 0v-.531c0-.895-.356-1.754-.988-2.386l-.548-.547z"/>
                    </svg>
                </div>
    ...
    <button @click="open = !open"
        ...
        :class="open ? 'rotate-0' : 'animate-bounce-subtle'">
