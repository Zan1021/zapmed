...
<body class="font-sans antialiased bg-white">
    ...
    <!-- Hero -->
    <section class="pt-28 pb-16 lg:pt-32 lg:pb-20 px-4 sm:px-6 lg:px-8 relative bg-cover bg-center bg-no-repeat" style="background-image: url('/images/hero-bg.png');">
        <!-- Overlay for text readability -->
        <div class="absolute inset-0 bg-white/80 sm:bg-white/70"></div>
        ...
        <div class="max-w-7xl mx-auto relative z-10">
            ...
            <!-- Trust badges -->
            <div class="mt-16 flex flex-wrap items-center justify-center gap-x-8 gap-y-4 text-sm text-gray-500">
