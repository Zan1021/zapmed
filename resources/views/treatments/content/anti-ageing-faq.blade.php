    ...
    <div class="space-y-3">
        <div class="border border-gray-200 rounded-xl overflow-hidden">
            <button @click="open = open === 1 ? null : 1" class="w-full flex items-center justify-between p-5 text-left">
                <span class="text-sm font-semibold text-gray-900">What ingredients are prescribed?</span>
            ...
            <div x-show="open === 1" x-collapse class="px-5 pb-5">
                <p class="text-sm text-gray-600">Our doctors prescribe proven prescription-strength ingredients like tretinoin (vitamin A), niacinamide, and azelaic acid based on your skin assessment and goals.</p>
            </div>
        </div>

        <div class="border border-gray-200 rounded-xl overflow-hidden">
            <button @click="open = open === 2 ? null : 2" class="w-full flex items-center justify-between p-5 text-left">
                <span class="text-sm font-semibold text-gray-900">How long until I see results?</span>
            ...
            <div x-show="open === 2" x-collapse class="px-5 pb-5">
                <p class="text-sm text-gray-600">Anti-ageing treatments work gradually. Expect to see initial improvements in skin texture within 4-6 weeks, with continued improvement over 3-6 months of consistent use.</p>
            </div>
        </div>
    </div>
</div>
