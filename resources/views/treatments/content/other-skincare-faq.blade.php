    ...
    <div class="space-y-3">
        <div class="border border-gray-200 rounded-xl overflow-hidden">
            <button @click="open = open === 1 ? null : 1" class="w-full flex items-center justify-between p-5 text-left">
                <span class="text-sm font-semibold text-gray-900">What skin conditions can you treat online?</span>
            ...
            <div x-show="open === 1" x-collapse class="px-5 pb-5">
                <p class="text-sm text-gray-600">We treat a wide range of skin conditions including hyperpigmentation, melasma, eczema, psoriasis, dermatitis, dry skin, and sun damage. If your condition requires an in-person examination, our doctor will let you know and refer you accordingly.</p>
            </div>
        </div>

        <div class="border border-gray-200 rounded-xl overflow-hidden">
            <button @click="open = open === 2 ? null : 2" class="w-full flex items-center justify-between p-5 text-left">
                <span class="text-sm font-semibold text-gray-900">Do I need to upload photos?</span>
            ...
            <div x-show="open === 2" x-collapse class="px-5 pb-5">
                <p class="text-sm text-gray-600">Photos are optional but highly recommended as they help the doctor assess your condition more accurately. Take clear, well-lit photos of the affected area from different angles for the best assessment.</p>
            </div>
        </div>

        <div class="border border-gray-200 rounded-xl overflow-hidden">
            <button @click="open = open === 3 ? null : 3" class="w-full flex items-center justify-between p-5 text-left">
                <span class="text-sm font-semibold text-gray-900">How long does treatment take to work?</span>
            ...
            <div x-show="open === 3" x-collapse class="px-5 pb-5">
                <p class="text-sm text-gray-600">Results vary by condition. Some conditions like eczema flare-ups may improve within days, while pigmentation concerns typically take 6-12 weeks to show visible improvement. Your doctor will set realistic expectations during your consultation.</p>
            </div>
        </div>
    </div>
</div>
