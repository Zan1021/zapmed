    ...
    <div class="space-y-3">
        <div class="border border-gray-200 rounded-xl overflow-hidden">
            <button @click="open = open === 1 ? null : 1" class="w-full flex items-center justify-between p-5 text-left">
                <span class="text-sm font-semibold text-gray-900">How does the STI consultation work?</span>
            ...
            <div x-show="open === 1" x-collapse class="px-5 pb-5">
                <p class="text-sm text-gray-600">Complete our confidential online assessment describing your symptoms. A doctor reviews your case and prescribes appropriate treatment. Medication is delivered discreetly to your door.</p>
            </div>
        </div>

        <div class="border border-gray-200 rounded-xl overflow-hidden">
            <button @click="open = open === 2 ? null : 2" class="w-full flex items-center justify-between p-5 text-left">
                <span class="text-sm font-semibold text-gray-900">Is the service confidential?</span>
            ...
            <div x-show="open === 2" x-collapse class="px-5 pb-5">
                <p class="text-sm text-gray-600">Yes, completely. All consultations are private and POPIA compliant. Medication arrives in unbranded packaging with no indication of contents. Your records are stored securely.</p>
            </div>
        </div>

        <div class="border border-gray-200 rounded-xl overflow-hidden">
            <button @click="open = open === 3 ? null : 3" class="w-full flex items-center justify-between p-5 text-left">
                <span class="text-sm font-semibold text-gray-900">Do I need a test result?</span>
            ...
            <div x-show="open === 3" x-collapse class="px-5 pb-5">
                <p class="text-sm text-gray-600">In many cases, our doctors can prescribe based on your symptoms. If a test is needed, your doctor will advise you accordingly during the consultation.</p>
            </div>
        </div>
    </div>
</div>
