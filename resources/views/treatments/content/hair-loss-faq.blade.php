    ...
    <div class="space-y-3">
        <div class="border border-gray-200 rounded-xl overflow-hidden">
            ...
            <div x-show="open === 1" x-collapse class="px-5 pb-5">
                <p class="text-sm text-gray-600">Hair loss treatments typically take 3-6 months to show visible results. Consistency is key — missing doses can reduce effectiveness. Our subscription service ensures you stay on track.</p>
            </div>
        </div>

        <div class="border border-gray-200 rounded-xl overflow-hidden">
            <button @click="open = open === 2 ? null : 2" class="w-full flex items-center justify-between p-5 text-left">
                <span class="text-sm font-semibold text-gray-900">Are there side effects?</span>
            ...
            <div x-show="open === 2" x-collapse class="px-5 pb-5">
                <p class="text-sm text-gray-600">Most patients tolerate hair loss medication well. Some may experience mild side effects which are typically temporary. Your doctor will discuss these with you during consultation and monitor your progress.</p>
            </div>
        </div>
    </div>
</div>
