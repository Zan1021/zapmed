...
<!-- Dashboard — all roles -->
<a href="{{ auth()->user()->isDoctor() ? route('doctor.dashboard') : route('dashboard') }}"
   class="flex items-center px-3 py-2.5 text-sm font-medium rounded-lg transition-colors {{ request()->routeIs('dashboard') || request()->routeIs('doctor.dashboard') ? 'bg-sidebar-active text-white' : 'text-slate-300 hover:bg-sidebar-hover hover:text-white' }}">
