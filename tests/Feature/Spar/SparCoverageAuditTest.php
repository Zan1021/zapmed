...
class SparCoverageAuditTest extends TestCase
{
    ...
    private function coverageMap(): array
    {
        return [
            ...
            'Actionable state machine (FR-B1)'              => SparActionableStateMachineTest::class,
            'Action service — nudge/snooze/message (FR-B2)' => SparActionServiceTest::class,
            'Exceptions action buttons (FR-B6)'             => SparExceptionsActionsTest::class,
            'Patient response signals (FR-B3/B4)'           => SparPatientSignalTest::class,
            'Import auto-resolve reconciler (FR-B5)'        => SparReconcilerTest::class,
