    ...
    <header class="border-b bg-white" style="border-color: {{ config('spar.branding.primary_color', '#006B3F') }}22;">
        <div class="mx-auto flex max-w-6xl items-center justify-between px-4 py-3">
            ...
            <nav class="flex items-center gap-4 text-sm">
                ...
                @auth
                    <a href="{{ route('admin.spar.orders') }}" class="flex items-center gap-1.5 hover:underline">
                    ...
                    <a href="{{ route('admin.spar.renewals') }}" class="flex items-center gap-1.5 hover:underline">
                    ...
                    <a href="{{ route('admin.spar.broadcast') }}" class="flex items-center gap-1.5 hover:underline">
