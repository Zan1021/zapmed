...
<body class="min-h-[100dvh] bg-gray-100 text-gray-900">
    <div class="mx-auto max-w-md flex flex-col">
        <header class="mx-4 mt-4 rounded-2xl px-4 pt-3 pb-2 text-center text-white" style="background: {{ config('spar.branding.primary_color', '#006B3F') }};">
            <div class="mx-auto -mb-2 inline-block">
                <img src="{{ asset(config('spar.branding.logo_path', 'img/pharmacy-at-spar-logo.jpg')) }}" alt="{{ config('spar.branding.name', 'SPAR Meds') }}" class="h-[99.84px] w-auto rounded">
            </div>
            <div class="text-[10px] uppercase tracking-widest opacity-80">Powered by ZapMed</div>
            <div class="text-2xl font-bold opacity-90">My Chronic Medication</div>
        </header>
