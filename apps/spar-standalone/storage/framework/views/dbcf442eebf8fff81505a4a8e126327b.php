<div>
     <?php $__env->slot('header', null, []); ?> Pharmacy Groups <?php $__env->endSlot(); ?>
        ...
        <div class="fixed inset-0 bg-black/50 z-50 flex items-center justify-center p-4" wire:click.self="resetForm">
            <div class="bg-white rounded-xl shadow-xl max-w-xl w-full max-h-[80vh] overflow-y-auto">
                <div class="p-5 border-b border-gray-100">
                    <h3 class="text-lg font-semibold text-gray-900"><?php echo e($editingId ? 'Edit' : 'Add'); ?> Group</h3>
                </div>
                ...
                <tbody class="divide-y divide-gray-100">
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $groups; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $group): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <tr class="hover:bg-gray-50">
                            <td class="p-3">
                                <p class="font-medium text-gray-900"><?php echo e($group->name); ?></p>
                                <p class="text-xs text-gray-500"><?php echo e($group->slug); ?></p>
                            </td>
                            <td class="p-3 text-gray-600"><?php echo e($group->region ?? '-'); ?></td>
                            <td class="p-3 text-gray-600">
                                <?php echo e($group->contact_name ?? '-'); ?>

                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($group->contact_email): ?><p class="text-xs text-gray-400"><?php echo e($group->contact_email); ?></p><?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                            </td>
                            <td class="p-3 text-center"><?php echo e($group->pharmacies_count); ?></td>
                            <td class="p-3 text-center">
                                <button wire:click="toggleActive(<?php echo e($group->id); ?>)" class="inline-flex items-center px-2 py-0.5 rounded-full text-xs font-medium cursor-pointer
                                    <?php echo e($group->is_active ? 'bg-green-100 text-green-800' : 'bg-gray-100 text-gray-600'); ?>">
                                    <?php echo e($group->is_active ? 'Active' : 'Inactive'); ?>

                                </button>
                            </td>
                            <td class="p-3 text-center">
                                <button wire:click="edit(<?php echo e($group->id); ?>)" class="text-blue-600 hover:text-blue-800 text-xs font-medium">Edit</button>
                            </td>
                        </tr>
...
<?php /**PATH C:\Users\zande\Documents\Zapmed\zapmed\packages\spar-core\src/../resources/views/livewire/admin/spar-groups.blade.php ENDPATH**/ ?>