...
class DoctorApplications extends Component
{
    ...
    public function approve(int $id)
    {
        ...
        try {
            app(NotificationDispatcher::class)->sendVia(new OutboundMessage(
                templateKey: 'doctor.application_approved',
                category: 'transactional',
                user: null,
                email: $application->email,
                subject: 'Welcome to Zapmed - Application Approved',
                body: "Dear Dr. {$application->first_name} {$application->last_name},\n\n" .
                    ...
                    "Welcome to the team!\n" .
                    "The Zapmed Team",
                meta: ['doctor_application_id' => $application->id],
            ), 'email');
        } catch (\Exception $e) {
    ...
    public function reject(int $id)
    {
        ...
        try {
            app(NotificationDispatcher::class)->sendVia(new OutboundMessage(
                templateKey: 'doctor.application_rejected',
                category: 'transactional',
                user: null,
                email: $application->email,
